...
<head>
    ...
    <script src="javascript/ajaxChat.js"></script>
    <script src="javascript/ajaxOptions.js"></script>
    <script src="javascript/ajaxParticipants.js"></script>
    <script src="javascript/ajaxStatus.js"></script>
    <script src="javascript/ajaxCall.js"></script>
...
<header>
    <div class="navbar">
        ...
        <li><a id="roomstatus">
            ...
            <li><a id="settings-label"><?php if($country == "Brazil") { echo ("Configurações"); } else { echo("Settings"); } ?></a>
                <ul id="settings-navbar">
                    ...
                    ?>
                    <li><button id="copylink" class="link-convite"><?php if($country == "Brazil") { echo ("Link de Convite"); } else { echo("Invite Link"); } ?></button></li>
                    <li><button id="trigger_file" class="mudar-foto-perfil"><?php if($country == "Brazil") { echo ("Mudar Foto de Perfil"); } else { echo("Change Profile Photo"); } ?></button></li>
                    <script>
            ...
            ?>
            <li><a id="report-label">Denunciar Sala</a>
                <ul id="report-navbar">
                    <li>
                        <form method="POST" target="fakeFrame">
                        <div class="input-join">
                        <p style="color: white;">Estou denunciando:</p>
                        <select name="report-nick" id="report-navbar-nicks">
                        <option value="volvo">Um ou mais usuários</option>
                        <option value="saab">Toda a Sala</option>
                        </select>
                        <p style="color: white; margin-top: 20px;">Motivo:</p>
                        <select name="report-nick" id="report-navbar-nicks">
                        <option value="volvo">Atividades criminosas</option>
                        <option value="saab">Discriminação </option>
                        </select>
                        <p style="color: white; font-size: 15px; margin-top: 20px;">Ao denunciar uma sala ou usuário, a administração do Fastalk terá acesso à conversa e tomará medidas cabíveis.</p>
                    </div>
                <button name="publicroom" style="background: linear-gradient(to left,#960909,#4d0505);" class="create2">Denunciar Sala</button>
                </form>
            </li>
            </ul>
    ...
    <iframe name="hiddenFrame" hidden></iframe>
        <form method="POST" target="hiddenFrame">
            ...
            <main id="chat" class="chat2" style="word-wrap: break-word;">
                            <h1 style="text-align: center; font-size: 20px; color: white;"><?php 
            if($country == "Brazil") {
                echo ("Carregando...");
            } else {
                echo ("Loading...");
        ...
        <main class="digitar">
            ...
            <div style="margin-left: 50px;" class="input-digitar" id="input-type">
                <input id="mensagem" contenteditable="true" <?php echo($disabled); ?> name="mensagem" style="margin-left: 5px; font-size: 15px;" class="input-digitar" onclick="returning()" onmouseenter="returning2()" autocomplete="off" type="text" placeholder="<?php 
            if($country == "Brazil") {
                echo ("Digite alguma coisa aqui...");
            } else {
