...
if(isMobile()){
    ...
    <main class="chat">
        ...
        if($country == "Brazil") {
            echo ('Erro: Por favor, preencha o captcha (Clique no quadrado branco no campo "Não sou um robô")');
        } else {
            $aspa = "'";
            echo ('Error: Please fill the captcha <br> (Click on the white square in the "I'.$aspa.'m not a robot" field)');
        }
        ?>
        </h4>
