...
<head>
    ...
    <?php
    if($country == "Brazil") {
    echo("O Fastalk é um sistema de chat rápido e anônimo onde não é utilizado sistema de criação de contas. Apenas coloque um nick e converse com quem você quiser.");
    } else {
        echo ("Fastalk is an anonymous fast chat system where no account creation system is used. Just put a nickname and chat with whoever you want.");
    }
    ?>
    '>
    ...
    <script src="javascript/ajaxCountUsers.js"></script>
    <script src="javascript/menu.js"></script>
    <title><?php
    if($country == "Brazil") {
    echo("Fastalk | Converse com quem quiser de forma rápida e segura");
    } else {
        echo ("Fastalk | Talk with whoever you want in a safe and fast way");
    }
    ?>
    </title>
</head>
...
if(isMobile()){
    ...
    <main class="chat">
        ...
        ?> <span style="color: rgb(154, 2, 255);" id="numbercount"><?php 
        ...
        ?></span> <?php 
        if($country == "Brazil") {
        echo ("usuários online nesse momento.");
        } else {
            echo ("online users right now");
        }
        ?>
        </h4>
            <h1><?php
            ...
            <div class="input-join">
                <input required id="join" name="join" autocomplete="off" type="text" placeholder="<?php if($country == "Brazil") { echo("ID da sala. EX: BJ2D5"); } else { echo ("Room ID. EX: BJ2D5"); } ?>">
                <div class="underline"></div>
            </div>
    ...
    <footer>
        <div class="rodape" <?php if(isMobile()) { echo("hidden"); } ?>>
            ...
            if($country == "Brazil") {
            echo ("O Fastalk é um sistema de chat rápido e anônimo onde você pode conversar com quem quiser, do seu jeito!");
            } else {
                echo ("Fastalk is an anonymous fast chat system where you can talk with whoever you want, from your own way!");
            }
            ?></p>
        </div>
    </footer>
